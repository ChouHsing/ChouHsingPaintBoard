...
data class User(val _id: Id<User>?, val username: String, val email: String, val password: String, val name: String, val stuId: Long)
...
data class Identity(val email: String, val name: String, val stuId: Long)
